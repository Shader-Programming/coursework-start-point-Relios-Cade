...
MyScene::MyScene(GLFWwindow* window, InputHandler* H) : Scene(window, H)
{
	...
	m_directionalLight->setLightUnifroms(m_myShader);
	...
	//m_pointLight = new PointLight(glm::vec3(1.0, 0.0, 0.0), glm::vec3(-2.0, 0.0, 3.0), glm::vec3(1.0, 0.22, 0.2));
	//m_pointLight->setLightUniforms(m_myShader);

	//m_pointLight2 = new PointLight(glm::vec3(1.0, 0.0, 0.0), glm::vec3(-2.0, 0.0, 3.0), glm::vec3(1.0, 0.22, 0.2));
...
void MyScene::render()
{
	...
	m_cube->rotate(0.01, glm::vec3(1.0, 1.0, 0.0));
